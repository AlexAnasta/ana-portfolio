...
const education: Education[] = [
	...
	},
	{
		...
		description:
			"Honours degree. Thesis on FOXO3A gene polymorphism and genetic predisposition to human longevity.",
		currentUni: false,
	},
	{
		...
		location: "Moscow, Russia",
		description:
			"Honours degree. Thesis on FCER1A polymorphisms (rs2251746 and rs2427837) for predicting risk of IgE-dependent diseases.",
		currentUni: false,
	},
	{
		title:
			"Machine Learning in Python for Solving Bioinformatics Problems (Advanced Course)",
		startDate: "2023-08-29",
		endDate: "2023-10-07",
		school: "BLASTIM",
		location: "Moscow, Russia",
		description:
			"Advanced training focused on applied machine learning techniques in bioinformatics.",
		currentUni: false,
	},
	{
		...
		location: "Moscow, Russia",
		description:
			"Intensive school on machine learning methods and practical bioinformatics applications.",
		currentUni: false,
	},
	{
		...
		location: "Moscow, Russia",
		description:
			"Advanced training on next-generation sequencing data analysis workflows.",
		currentUni: false,
	},
	{
		...
		location: "Moscow, Russia",
		description:
			"Applied statistics and R-based data analysis for scientific projects.",
		currentUni: false,
	},
	{
		...
		location: "Moscow, Russia",
		description:
			"Practical training on Python and R usage for NGS analysis pipelines.",
		currentUni: false,
	},
	{
		...
		location: "Online",
		description:
			"Training focused on communicating scientific results effectively.",
		currentUni: false,
	},
];
