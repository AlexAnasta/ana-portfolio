	...
	skillCategories: [
		...
		},
		{
			...
			skills: [
				...
				{ name: "NGS Sample Preparation", description: "Prepared Illumina sequencing libraries; familiar with the full wet-lab preparation workflow.", icon: "sequencingLab", badges: ["wet lab"], level: 1 },
